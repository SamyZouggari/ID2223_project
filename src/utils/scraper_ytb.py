...
finbert_model = AutoModelForSequenceClassification.from_pretrained("burakutf/finetuned-finbert-crypto")
finbert_tokenizer = AutoTokenizer.from_pretrained("burakutf/finetuned-finbert-crypto")
...
def main():
    ...
    for idx, article in enumerate(all_articles, 1):
        ...
        polarity, sentiment = analyze_sentiment(article['title'] + " " + article['content'])  # or article['content']
